...
![type: application](https://img.shields.io/badge/type-application-informational?style=flat-square)  [![artifact hub](https://img.shields.io/badge/artifact%20hub-meterforge-informational?style=flat-square)](https://artifacthub.io/packages/helm/meterforge/meterforge)
...
```bash
helm install --generate-name --wait oci://ghcr.io/Pototoooo/helm-charts/meterforge
```

to install a specific version:

```bash
helm install --generate-name --wait oci://ghcr.io/Pototoooo/helm-charts/meterforge --version $VERSION
```

## Getting started

MeterForge needs meters to be defined in configuration to process events:
...
## Running MeterForge in production
...
|-----|------|---------|-------------|
| image.repository | string | `"ghcr.io/Pototoooo/meterforge"` | Name of the image repository to pull the container image from. |
...
| config | object | `{}` | MeterForge configuration |
