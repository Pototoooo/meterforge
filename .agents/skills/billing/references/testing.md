...
POSTGRES_HOST=127.0.0.1 go test -tags=dynamic -v ./meterforge/billing/worker/subscriptionsync/service/...

# Just charges tests
POSTGRES_HOST=127.0.0.1 go test -tags=dynamic -v ./meterforge/billing/charges/...
...
```bash
TEST_DISABLE_ATLAS=true POSTGRES_HOST=127.0.0.1 go test -tags=dynamic -v ./meterforge/billing/...
```
