...
import (
	...
	"github.com/Pototoooo/meterforge/meterforge/session"
...
func TestEvents(t *testing.T) {
	...
	t.Run("CreatedEvent", func(t *testing.T) {
		...
		// Test event name
		assert.Equal(t, "io.meterforge.subscriptionaddon.v1.subscriptionaddon.created", event.EventName())

		// Test event metadata
		metadata := event.EventMetadata()
		assert.Equal(t, "//github.com/Pototoooo/meterforge/namespace/test-namespace/subscriptionAddon/test-subscription-addon-id", metadata.Source)
		assert.Equal(t, "//github.com/Pototoooo/meterforge/namespace/test-namespace/customer/test-customer-id", metadata.Subject)
	...
	t.Run("ChangeQuantityEvent", func(t *testing.T) {
		...
		// Test event name
		assert.Equal(t, "io.meterforge.subscriptionaddon.v1.subscriptionaddon.changequantity", event.EventName())
