...
import (
	...
	kafkastats "github.com/Pototoooo/meterforge/pkg/kafka/metrics/stats"
	"github.com/Pototoooo/meterforge/pkg/otelx"
)
...
func (s Collector) Ingest(ctx context.Context, namespace string, ev event.Event) error {
	...
	ctx, span := s.Tracer.Start(ctx, "meterforge.ingest.process.event", trace.WithAttributes(
