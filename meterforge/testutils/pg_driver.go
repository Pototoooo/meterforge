...
import (
	...
	entschema "github.com/Pototoooo/meterforge/meterforge/ent"
...
func (emptyMigrator) Hash() (string, error) {
	return common.NewRecursiveHash(
		common.Field("migrator", "meterforge-empty-v1"),
	).String(), nil
}
...
func (entMigrator) Hash() (string, error) {
	hash := common.NewRecursiveHash(
		common.Field("migrator", "meterforge-ent-v1"),
	)
...
func (m atlasMigrator) Hash() (string, error) {
	...
	hash := common.NewRecursiveHash(
		common.Field("migrator", "meterforge-atlas-v1"),
