...
const (
	StripeMetadataNamespace  = "mf_namespace"
	StripeMetadataAppID      = "mf_app_id"
	StripeMetadataCustomerID = "mf_customer_id"
	StripeMetadataInvoiceID  = "mf_invoice_id"
)

// SetupIntentReservedMetadataKeys are the keys that are reserved for internal use by MeterForge
