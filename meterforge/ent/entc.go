...
import (
	...
	"github.com/Pototoooo/meterforge/pkg/framework/entutils/entmixinaccessor"
	"github.com/Pototoooo/meterforge/pkg/framework/entutils/entpaginate"
	"github.com/Pototoooo/meterforge/pkg/framework/entutils/entsetorclear"
...
func main() {
	err := entc.Generate("./schema",
		&gen.Config{
			...
			Target:  "./db",
			Schema:  "./schema",
			Package: "github.com/Pototoooo/meterforge/meterforge/ent/db",
		},
		entc.Extensions(
			entcursor.New(),
			entexpose.New(),
