...
import (
	...
	costpkg "github.com/Pototoooo/meterforge/meterforge/cost"
	"github.com/Pototoooo/meterforge/meterforge/credit"
	"github.com/Pototoooo/meterforge/meterforge/credit/engine"
	...
	metereventadapter "github.com/Pototoooo/meterforge/meterforge/meterevent/adapter"
	...
	progressmanageradapter "github.com/Pototoooo/meterforge/meterforge/progressmanager/adapter"
	...
	"github.com/Pototoooo/meterforge/meterforge/watermill/marshaler"
	...
	"github.com/Pototoooo/meterforge/pkg/ref"
	...
	tests := []struct {
		...
		},
		{
			...
			req: testRequest{
				method:      http.MethodPost,
				contentType: "application/json",
				path:        "/api/v3/meterforge/meters/" + mockMeters[0].ID + "/query",
		...
		// Update meter v3
		{
			...
			req: testRequest{
				...
				contentType: "application/json",
				path:        "/api/v3/meterforge/meters/" + mockMeters[0].ID,
		...
		// Charges
		{
			...
			req: testRequest{
				method: http.MethodGet,
				path:   "/api/v3/meterforge/customers/01ARZ3NDEKTSV4RRFFQ69G5FAV/charges",
			},
			res: testResponse{
				status: http.StatusNotImplemented,
			},
		...
		// Debug
		{
			...
			req: testRequest{
				...
				body:        `meterforge_events_total{subject="customer-1"} 2.0`,
			},
			res: testResponse{
				status: http.StatusOK,
			},
...
func TestListCustomerChargesRoute(t *testing.T) {
	...
	path := "/api/v3/meterforge/customers/" + customerID + "/charges"
...
func (h MockDebugHandler) GetDebugMetrics(ctx context.Context, namespace string) (string, error) {
	return `meterforge_events_total{subject="customer-1"} 2.0`, nil
}
