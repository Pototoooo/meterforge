 ...
 * MeterForge Legacy Cloud-Compatible API
 * MeterForge is a cloud native usage metering service.
 * The MeterForge API allows you to ingest events, query meter usage, and manage resources.
...
export const CreateStripeCheckoutSessionBody = zod
  .object({
    ...
    customer: zod
      ...
      .describe(
        'Provide a customer ID or key to use an existing MeterForge customer.\nor provide a customer object to create a new customer.',
      ),
    options: zod
      .object({
...
/**
 * MeterForge has three types of entitlements: metered, boolean, and static. The type property determines the type of entitlement. The underlying feature has to be compatible with the entitlement type specified in the request (e.g., a metered entitlement needs a feature associated with a meter).
 *
