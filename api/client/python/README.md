# MeterForge Python SDK

[On PyPI](https://pypi.org/project/meterforge)
...
```sh
pip install --pre meterforge
# or using an exact version
pip install meterforge==1.0.0bXXX
```
...
```python
from meterforge.models import MeterQueryResult
...
The MeterForge Python SDK provides a comprehensive client interface organized into logical operation groups. Below is a complete reference of all available methods.
