...
class MeterForgeClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    """MeterForge is a cloud native usage metering service. The MeterForge API allows you to ingest
    events, query meter usage, and manage resources.

    :ivar portal: PortalOperations operations
    :vartype portal: meterforge.aio.operations.PortalOperations
    :ivar apps: AppsOperations operations
    :vartype apps: meterforge.aio.operations.AppsOperations
    :ivar app_stripe: AppStripeOperations operations
    :vartype app_stripe: meterforge.aio.operations.AppStripeOperations
    :ivar customer_apps: CustomerAppsOperations operations
    :vartype customer_apps: meterforge.aio.operations.CustomerAppsOperations
    :ivar customers: CustomersOperations operations
    :vartype customers: meterforge.aio.operations.CustomersOperations
    :ivar features: FeaturesOperations operations
    :vartype features: meterforge.aio.operations.FeaturesOperations
    :ivar plans: PlansOperations operations
    :vartype plans: meterforge.aio.operations.PlansOperations
    :ivar plan_addons: PlanAddonsOperations operations
    :vartype plan_addons: meterforge.aio.operations.PlanAddonsOperations
    :ivar addons: AddonsOperations operations
    :vartype addons: meterforge.aio.operations.AddonsOperations
    :ivar subscriptions: SubscriptionsOperations operations
    :vartype subscriptions: meterforge.aio.operations.SubscriptionsOperations
    :ivar subscription_addons: SubscriptionAddonsOperations operations
    :vartype subscription_addons: meterforge.aio.operations.SubscriptionAddonsOperations
    :ivar entitlements: EntitlementsOperations operations
    :vartype entitlements: meterforge.aio.operations.EntitlementsOperations
    :ivar grants: GrantsOperations operations
    :vartype grants: meterforge.aio.operations.GrantsOperations
    :ivar subjects: SubjectsOperations operations
    :vartype subjects: meterforge.aio.operations.SubjectsOperations
    :ivar customer: CustomerOperations operations
    :vartype customer: meterforge.aio.operations.CustomerOperations
    :ivar customer_entitlement: CustomerEntitlementOperations operations
    :vartype customer_entitlement: meterforge.aio.operations.CustomerEntitlementOperations
    :ivar customer_stripe: CustomerStripeOperations operations
    :vartype customer_stripe: meterforge.aio.operations.CustomerStripeOperations
    :ivar marketplace: MarketplaceOperations operations
    :vartype marketplace: meterforge.aio.operations.MarketplaceOperations
    :ivar app_custom_invoicing: AppCustomInvoicingOperations operations
    :vartype app_custom_invoicing: meterforge.aio.operations.AppCustomInvoicingOperations
    :ivar events: EventsOperations operations
    :vartype events: meterforge.aio.operations.EventsOperations
    :ivar events_v2: EventsV2Operations operations
    :vartype events_v2: meterforge.aio.operations.EventsV2Operations
    :ivar meters: MetersOperations operations
    :vartype meters: meterforge.aio.operations.MetersOperations
    :ivar subjects: SubjectsOperations operations
    :vartype subjects: meterforge.aio.operations.SubjectsOperations
    :ivar debug: DebugOperations operations
    :vartype debug: meterforge.aio.operations.DebugOperations
    :ivar notification_channels: NotificationChannelsOperations operations
    :vartype notification_channels: meterforge.aio.operations.NotificationChannelsOperations
    :ivar notification_rules: NotificationRulesOperations operations
    :vartype notification_rules: meterforge.aio.operations.NotificationRulesOperations
    :ivar notification_events: NotificationEventsOperations operations
    :vartype notification_events: meterforge.aio.operations.NotificationEventsOperations
    :ivar entitlements_v2: EntitlementsV2Operations operations
    :vartype entitlements_v2: meterforge.aio.operations.EntitlementsV2Operations
    :ivar customer_entitlements_v2: CustomerEntitlementsV2Operations operations
    :vartype customer_entitlements_v2: meterforge.aio.operations.CustomerEntitlementsV2Operations
    :ivar customer_entitlement_v2: CustomerEntitlementV2Operations operations
    :vartype customer_entitlement_v2: meterforge.aio.operations.CustomerEntitlementV2Operations
    :ivar grants_v2: GrantsV2Operations operations
    :vartype grants_v2: meterforge.aio.operations.GrantsV2Operations
    :ivar billing_profiles: BillingProfilesOperations operations
    :vartype billing_profiles: meterforge.aio.operations.BillingProfilesOperations
    :ivar customer_overrides: CustomerOverridesOperations operations
    :vartype customer_overrides: meterforge.aio.operations.CustomerOverridesOperations
    :ivar invoices: InvoicesOperations operations
    :vartype invoices: meterforge.aio.operations.InvoicesOperations
    :ivar invoice: InvoiceOperations operations
    :vartype invoice: meterforge.aio.operations.InvoiceOperations
    :ivar customer_invoice: CustomerInvoiceOperations operations
    :vartype customer_invoice: meterforge.aio.operations.CustomerInvoiceOperations
    :ivar progress: ProgressOperations operations
    :vartype progress: meterforge.aio.operations.ProgressOperations
    :ivar currencies: CurrenciesOperations operations
    :vartype currencies: meterforge.aio.operations.CurrenciesOperations
    ...
    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        ...
        _endpoint = "{endpoint}"
        self._config = MeterForgeClientConfiguration(endpoint=endpoint, **kwargs)
