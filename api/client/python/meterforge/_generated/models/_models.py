...
class Addon(_Model):
    ...
    :vartype metadata: ~meterforge._generated.models.Metadata
    ...
    :vartype annotations: ~meterforge._generated.models.Annotations
    :ivar version: Version. Required.
    :vartype version: int
    :ivar instance_type: InstanceType. Required. Known values are: "single" and "multiple".
    :vartype instance_type: str or ~meterforge.models.AddonInstanceType
    ...
    :vartype status: str or ~meterforge.models.AddonStatus
    :ivar rate_cards: Rate cards. Required.
    :vartype rate_cards: list[~meterforge._generated.models.RateCardFlatFee or
     ~meterforge._generated.models.RateCardUsageBased]
    :ivar validation_errors: Validation errors. Required.
    :vartype validation_errors: list[~meterforge._generated.models.ValidationError]
    """
...
class AppCapability(_Model):
    ...
    :vartype type: str or ~meterforge.models.AppCapabilityType
    :ivar key: Key. Required.
    :vartype key: str
...
class AppPaginatedResponse(_Model):
    ...
    :vartype items_property: list[~meterforge._generated.models.StripeApp or
     ~meterforge._generated.models.SandboxApp or ~meterforge._generated.models.CustomInvoicingApp]
    """
...
class BalanceHistoryWindow(_Model):
    ...
    :vartype period: ~meterforge._generated.models.Period
...
class BillingCustomerProfile(_Model):
    ...
    :ivar supplier: The name and contact information for the supplier this billing profile
     represents. Required.
    :vartype supplier: ~meterforge._generated.models.BillingParty
    :ivar workflow: The billing workflow settings for this profile. Required.
    :vartype workflow: ~meterforge._generated.models.BillingWorkflow
    ...
    :vartype apps: ~meterforge._generated.models.BillingProfileApps or
     ~meterforge._generated.models.BillingProfileAppReferences
    """
...
class BillingDiscounts(_Model):
    ...
    :vartype percentage: ~meterforge._generated.models.BillingDiscountPercentage
    :ivar usage: The usage discount.
    :vartype usage: ~meterforge._generated.models.BillingDiscountUsage
    """
...
class BillingInvoiceCustomerExtendedDetails(_Model):
    ...
    These fields contain the MeterForge specific details for the customer, that are not strictly
    ...
    :vartype tax_id: ~meterforge._generated.models.BillingPartyTaxIdentity
    :ivar addresses: Regular post addresses for where information should be sent if needed.
    :vartype addresses: list[~meterforge._generated.models.Address]
    :ivar usage_attribution: Usage Attribution. Required.
    :vartype usage_attribution: ~meterforge._generated.models.CustomerUsageAttribution
    """
...
class BillingProfileAppReferences(_Model):
    ...
    :vartype tax: ~meterforge._generated.models.AppReference
    :ivar invoicing: The invoicing app used for this workflow. Required.
    :vartype invoicing: ~meterforge._generated.models.AppReference
    :ivar payment: The payment app used for this workflow. Required.
    :vartype payment: ~meterforge._generated.models.AppReference
    """
...
class BillingProfileApps(_Model):
    ...
    :vartype tax: ~meterforge._generated.models.StripeApp or
     ~meterforge._generated.models.SandboxApp or ~meterforge._generated.models.CustomInvoicingApp
    ...
    :vartype invoicing: ~meterforge._generated.models.StripeApp or
     ~meterforge._generated.models.SandboxApp or ~meterforge._generated.models.CustomInvoicingApp
    :ivar payment: The payment app used for this workflow. Required. Is one of the following types:
     StripeApp, SandboxApp, CustomInvoicingApp
    :vartype payment: ~meterforge._generated.models.StripeApp or
     ~meterforge._generated.models.SandboxApp or ~meterforge._generated.models.CustomInvoicingApp
    """
...
class BillingProfileCreate(_Model):
    ...
    :vartype default: bool
    :ivar workflow: The billing workflow settings for this profile. Required.
    :vartype workflow: ~meterforge._generated.models.BillingWorkflowCreate
    :ivar apps: The apps used by this billing profile. Required.
    :vartype apps: ~meterforge._generated.models.BillingProfileAppsCreate
    """
...
class BillingProfileCustomerOverrideWithDetails(_Model):  # pylint: disable=name-too-long
    ...
    :vartype customer_override: ~meterforge._generated.models.BillingProfileCustomerOverride
    ...
    :vartype customer_profile: ~meterforge._generated.models.BillingCustomerProfile
    :ivar customer: The customer this override belongs to.
    :vartype customer: ~meterforge._generated.models.Customer
    """
...
class BillingProfileCustomerOverrideWithDetailsPaginatedResponse(_Model):  # pylint: disable=name-too-long
    ...
    :vartype items_property:
     list[~meterforge._generated.models.BillingProfileCustomerOverrideWithDetails]
    """
...
class BillingProfilePaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~meterforge._generated.models.BillingProfile]
    """
...
class BillingWorkflow(_Model):
    ...
    :vartype collection: ~meterforge._generated.models.BillingWorkflowCollectionSettings
    :ivar invoicing: The invoicing settings for this workflow.
    :vartype invoicing: ~meterforge._generated.models.BillingWorkflowInvoicingSettings
    :ivar payment: The payment settings for this workflow.
    :vartype payment: ~meterforge._generated.models.BillingWorkflowPaymentSettings
    :ivar tax: The tax settings for this workflow.
    :vartype tax: ~meterforge._generated.models.BillingWorkflowTaxSettings
    """
...
class BillingWorkflowCollectionAlignmentAnchored(_Model):  # pylint: disable=name-too-long
    ...
    :ivar type: The type of alignment. Required. Align the collection to the anchor time and
     cadence.
    :vartype type: str or ~meterforge._generated.models.ANCHORED
    :ivar recurring_period: The recurring period for the alignment. Required.
    :vartype recurring_period: ~meterforge._generated.models.RecurringPeriodV2
    """
...
class BillingWorkflowCollectionAlignmentSubscription(_Model):  # pylint: disable=name-too-long
    ...
    :ivar type: The type of alignment. Required. Align the collection to the start of the
     subscription period.
    :vartype type: str or ~meterforge._generated.models.SUBSCRIPTION
    """
...
class BillingWorkflowCollectionSettings(_Model):
    ...
    :vartype alignment:
     ~meterforge._generated.models.BillingWorkflowCollectionAlignmentSubscription or
     ~meterforge._generated.models.BillingWorkflowCollectionAlignmentAnchored
...
class BillingWorkflowInvoicingSettings(_Model):
    ...
    :vartype subscription_end_proration_mode: str or
     ~meterforge.models.BillingWorkflowInvoicingSubscriptionEndProrationMode
    :ivar default_tax_config: Default tax configuration to apply to the invoices.
     ...
     fully supported.
    :vartype default_tax_config: ~meterforge._generated.models.TaxConfig
    """
...
class BillingWorkflowPaymentSettings(_Model):
    ...
    :vartype collection_method: str or ~meterforge.models.CollectionMethod
    """
...
class BillingWorkflowTaxSettings(_Model):
    ...
    :ivar enforced: Enforce tax calculation when tax is supported by the app. When enabled,
     MeterForge will not allow to create an invoice without tax calculation. Enforcement is
     different per apps, for example, Stripe app requires customer to have a tax location when
    ...
    """Enforce tax calculation when tax is supported by the app. When enabled, MeterForge will not
...
class CancelRequest(_Model):
    ...
    :vartype timing: str or ~meterforge.models.SubscriptionTimingEnum or ~datetime.datetime
    """
...
class CheckoutSessionCustomTextAfterSubmitParams(_Model):  # pylint: disable=name-too-long
    ...
    :vartype after_submit: ~meterforge._generated.models.CheckoutSessionCustomTextParamsAfterSubmit
    :ivar shipping_address: Custom text that should be displayed alongside shipping address
     collection.
    :vartype shipping_address:
     ~meterforge._generated.models.CheckoutSessionCustomTextParamsShippingAddress
    :ivar submit: Custom text that should be displayed alongside the payment confirmation button.
    :vartype submit: ~meterforge._generated.models.CheckoutSessionCustomTextParamsSubmit
    ...
    :vartype terms_of_service_acceptance:
     ~meterforge._generated.models.CheckoutSessionCustomTextParamsTermsOfServiceAcceptance
    """
...
class ClientAppStartResponse(_Model):
    """Response from the client app (MeterForge backend) to start the OAuth2 flow.
...
class CreateCheckoutSessionTaxIdCollection(_Model):
    ...
    :vartype required: str or ~meterforge.models.CreateCheckoutSessionTaxIdCollectionRequired
    """
...
class CreateStripeCheckoutSessionConsentCollection(_Model):  # pylint: disable=name-too-long
    ...
    :vartype payment_method_reuse_agreement:
     ~meterforge._generated.models.CreateStripeCheckoutSessionConsentCollectionPaymentMethodReuseAgreement
    ...
    :vartype promotions: str or
     ~meterforge.models.CreateStripeCheckoutSessionConsentCollectionPromotions
    ...
    :vartype terms_of_service: str or
     ~meterforge.models.CreateStripeCheckoutSessionConsentCollectionTermsOfService
    """
...
class CreateStripeCheckoutSessionConsentCollectionPaymentMethodReuseAgreement(_Model):  # pylint: disable=name-too-long
    ...
    :vartype position: str or
     ~meterforge.models.CreateStripeCheckoutSessionConsentCollectionPaymentMethodReuseAgreementPosition
    """
...
class CreateStripeCheckoutSessionCustomerUpdate(_Model):  # pylint: disable=name-too-long
    ...
    :vartype address: str or ~meterforge.models.CreateStripeCheckoutSessionCustomerUpdateBehavior
    :ivar name: Describes whether Checkout saves the name onto customer.name. Defaults to never.
     Known values are: "auto" and "never".
    :vartype name: str or ~meterforge.models.CreateStripeCheckoutSessionCustomerUpdateBehavior
    :ivar shipping: Describes whether Checkout saves shipping information onto customer.shipping.
     ...
     values are: "auto" and "never".
    :vartype shipping: str or ~meterforge.models.CreateStripeCheckoutSessionCustomerUpdateBehavior
    """
...
class CreateStripeCheckoutSessionRequest(_Model):
    ...
    :vartype app_id: str
    :ivar customer: Provide a customer ID or key to use an existing MeterForge customer. or provide
     a customer object to create a new customer. Required. Is one of the following types:
     CustomerId, CustomerKey, CustomerCreate
    :vartype customer: ~meterforge._generated.models.CustomerId or
     ~meterforge._generated.models.CustomerKey or ~meterforge._generated.models.CustomerCreate
    :ivar stripe_customer_id: Stripe customer ID. If not provided MeterForge creates a new Stripe
     customer or uses the MeterForge customer's default Stripe customer ID.
    :vartype stripe_customer_id: str
    :ivar options: Options passed to Stripe when creating the checkout session. Required.
    :vartype options: ~meterforge._generated.models.CreateStripeCheckoutSessionRequestOptions
    """
    ...
    """Provide a customer ID or key to use an existing MeterForge customer. or provide a customer
    ...
    """Stripe customer ID. If not provided MeterForge creates a new Stripe customer or uses the
     MeterForge customer's default Stripe customer ID."""
...
class CreateStripeCheckoutSessionRequestOptions(_Model):  # pylint: disable=name-too-long
    ...
    :vartype billing_address_collection: str or
     ~meterforge.models.CreateStripeCheckoutSessionBillingAddressCollection
    ...
    :vartype customer_update:
     ~meterforge._generated.models.CreateStripeCheckoutSessionCustomerUpdate
    :ivar consent_collection: Configure fields for the Checkout Session to gather active consent
     from customers.
    :vartype consent_collection:
     ~meterforge._generated.models.CreateStripeCheckoutSessionConsentCollection
    ...
    :vartype custom_text: ~meterforge._generated.models.CheckoutSessionCustomTextAfterSubmitParams
    ...
    :ivar ui_mode: The UI mode of the Session. Defaults to hosted. Known values are: "embedded" and
     "hosted".
    :vartype ui_mode: str or ~meterforge.models.CheckoutSessionUIMode
    ...
    :vartype redirect_on_completion: str or
     ~meterforge.models.CreateStripeCheckoutSessionRedirectOnCompletion
    :ivar tax_id_collection: Controls tax ID collection during checkout.
    :vartype tax_id_collection: ~meterforge._generated.models.CreateCheckoutSessionTaxIdCollection
    """
...
class CreateStripeCheckoutSessionResult(_Model):
    ...
    :ivar customer_id: The MeterForge customer ID. Required.
    :vartype customer_id: str
    ...
    :vartype mode: str or ~meterforge.models.StripeCheckoutSessionMode
    ...
    customer_id: str = rest_field(name="customerId", visibility=["read", "create", "update", "delete", "query"])
    """The MeterForge customer ID. Required."""
...
class InvoiceGenericDocumentRef(_Model):
    ...
    :vartype type: str or ~meterforge.models.InvoiceDocumentRefType
...
class CreditNoteOriginalInvoiceRef(InvoiceGenericDocumentRef):
    ...
    :vartype type: str or ~meterforge._generated.models.CREDIT_NOTE_ORIGINAL_INVOICE
...
class Currency(_Model):
    """Currency describes a currency supported by MeterForge.
...
class Customer(_Model):
    ...
    :vartype billing_address: ~meterforge._generated.models.Address
    :ivar current_subscription_id: Current Subscription ID.
    :vartype current_subscription_id: str
    :ivar subscriptions: Subscriptions.
    :vartype subscriptions: list[~meterforge._generated.models.Subscription]
    :ivar annotations: Annotations.
    :vartype annotations: ~meterforge._generated.models.Annotations
    """
...
class CustomerAccess(_Model):
    ...
    :vartype entitlements: dict[str, ~meterforge._generated.models.EntitlementValue]
    """
...
class CustomerAppDataPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~meterforge._generated.models.StripeCustomerAppData or
     ~meterforge._generated.models.SandboxCustomerAppData or
     ~meterforge._generated.models.CustomInvoicingCustomerAppData]
    """
...
class CustomerPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~meterforge._generated.models.Customer]
    """
...
class CustomInvoicingApp(_Model):
    ...
    :vartype listing: ~meterforge._generated.models.MarketplaceListing
    :ivar status: Status of the app connection. Required. Known values are: "ready" and
     "unauthorized".
    :vartype status: str or ~meterforge.models.AppStatus
    :ivar type: The app's type is CustomInvoicing. Required. CUSTOM_INVOICING.
    :vartype type: str or ~meterforge._generated.models.CUSTOM_INVOICING
...
class CustomInvoicingCustomerAppData(_Model):
    ...
    :vartype app: ~meterforge._generated.models.CustomInvoicingApp
    :ivar id: App ID.
    :vartype id: str
...
class CustomInvoicingDraftSynchronizedRequest(_Model):
    ...
    :vartype invoicing: ~meterforge._generated.models.CustomInvoicingSyncResult
    """
...
class CustomInvoicingFinalizedRequest(_Model):
    ...
    :ivar invoicing: The result of the synchronization.
    :vartype invoicing: ~meterforge._generated.models.CustomInvoicingFinalizedInvoicingRequest
    :ivar payment: The result of the payment synchronization.
    :vartype payment: ~meterforge._generated.models.CustomInvoicingFinalizedPaymentRequest
    """
...
class CustomInvoicingSyncResult(_Model):
    ...
    :vartype line_external_ids:
     list[~meterforge._generated.models.CustomInvoicingLineExternalIdMapping]
    ...
    :vartype line_discount_external_ids:
     list[~meterforge._generated.models.CustomInvoicingLineDiscountExternalIdMapping]
    """
...
class CustomInvoicingUpdatePaymentStatusRequest(_Model):  # pylint: disable=name-too-long
    ...
    :vartype trigger: str or ~meterforge.models.CustomInvoicingPaymentTrigger
    """
...
class OmitPropertiesResourceCreateModel(_Model):
    ...
    :vartype alignment: ~meterforge._generated.models.Alignment
    :ivar currency: Currency. Required.
    :vartype currency: str
    ...
    :vartype pro_rating_config: ~meterforge._generated.models.ProRatingConfig
    :ivar settlement_mode: Settlement mode. Known values are: "credit_then_invoice" and
     "credit_only".
    :vartype settlement_mode: str or ~meterforge.models.BillingSettlementMode
    :ivar phases: Plan phases. Required.
    :vartype phases: list[~meterforge._generated.models.PlanPhase]
    """
...
class CustomSubscriptionChange(_Model):
    ...
    :vartype custom_plan: ~meterforge._generated.models.CustomPlanInput
    """
...
class DiscountReasonMaximumSpend(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.MAXIMUM_SPEND
    """
...
class DiscountReasonRatecardPercentage(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.RATECARD_PERCENTAGE
    :ivar percentage: Percentage. Required.
    :vartype percentage: float
    :ivar correlation_id: Correlation ID for the discount.
...
class DiscountReasonRatecardUsage(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.RATECARD_USAGE
    :ivar quantity: Usage. Required.
    :vartype quantity: str
    :ivar correlation_id: Correlation ID for the discount.
...
class Discounts(_Model):
    ...
    :ivar percentage: The percentage discount.
    :vartype percentage: ~meterforge._generated.models.DiscountPercentage
    :ivar usage: The usage discount.
    :vartype usage: ~meterforge._generated.models.DiscountUsage
    """
...
class DynamicPriceWithCommitments(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.DYNAMIC
...
class EditSubscriptionAddItem(_Model):
    ...
    :vartype op: str or ~meterforge._generated.models.ADD_ITEM
    ...
    :vartype rate_card: ~meterforge._generated.models.RateCardFlatFee or
     ~meterforge._generated.models.RateCardUsageBased
    """
...
class EditSubscriptionAddPhase(_Model):
    ...
    :vartype op: str or ~meterforge._generated.models.ADD_PHASE
    :ivar phase: Required.
    :vartype phase: ~meterforge._generated.models.SubscriptionPhaseCreate
    """
...
class EditSubscriptionRemoveItem(_Model):
    ...
    :vartype op: str or ~meterforge._generated.models.REMOVE_ITEM
    :ivar phase_key: Required.
    :vartype phase_key: str
...
class EditSubscriptionRemovePhase(_Model):
    ...
    :vartype op: str or ~meterforge._generated.models.REMOVE_PHASE
    :ivar phase_key: Required.
    :vartype phase_key: str
    :ivar shift: Required. Known values are: "next" and "prev".
    :vartype shift: str or ~meterforge.models.RemovePhaseShifting
    """
...
class EditSubscriptionStretchPhase(_Model):
    ...
    :vartype op: str or ~meterforge._generated.models.STRETCH_PHASE
    :ivar phase_key: Required.
    :vartype phase_key: str
...
class EditSubscriptionUnscheduleEdit(_Model):
    ...
    :vartype op: str or ~meterforge._generated.models.UNSCHEDULE_EDIT
    """
...
class EntitlementBoolean(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.BOOLEAN
    :ivar created_at: Creation Time. Required.
    :vartype created_at: ~datetime.datetime
    :ivar updated_at: Last Update Time. Required.
    :vartype updated_at: ~datetime.datetime
    ...
    :vartype current_usage_period: ~meterforge._generated.models.Period
    :ivar usage_period: The defined usage period of the entitlement.
    :vartype usage_period: ~meterforge._generated.models.RecurringPeriod
    """
...
class EntitlementBooleanCreateInputs(_Model):
    ...
    :vartype usage_period: ~meterforge._generated.models.RecurringPeriodCreateInput
    :ivar type: Required. BOOLEAN.
    :vartype type: str or ~meterforge._generated.models.BOOLEAN
    """
...
class EntitlementGrant(_Model):
    ...
    :vartype expiration: ~meterforge._generated.models.ExpirationPeriod
    ...
    :vartype recurrence: ~meterforge._generated.models.RecurringPeriod
...
class EntitlementGrantCreateInput(_Model):
    ...
    :vartype recurrence: ~meterforge._generated.models.RecurringPeriodCreateInput
    """
...
class EntitlementMetered(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.METERED
...
class EntitlementMeteredCreateInputs(_Model):
    ...
    :vartype measure_usage_from: str or ~meterforge.models.MeasureUsageFromPreset or
     ~datetime.datetime
    :ivar issue_after_reset: Initial grant amount.
    :vartype issue_after_reset: float
    :ivar issue_after_reset_priority: Issue grant after reset priority.
...
class EntitlementMeteredV2(_Model):
    ...
    :vartype issue: ~meterforge._generated.models.IssueAfterReset
    :ivar created_at: Creation Time. Required.
    :vartype created_at: ~datetime.datetime
    :ivar updated_at: Last Update Time. Required.
    :vartype updated_at: ~datetime.datetime
...
class EntitlementMeteredV2CreateInputs(_Model):
    ...
    :vartype issue: ~meterforge._generated.models.IssueAfterReset
    :ivar grants: Grants.
    :vartype grants: list[~meterforge._generated.models.EntitlementGrantCreateInputV2]
    """
...
class EntitlementPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~meterforge._generated.models.EntitlementMetered or
     ~meterforge._generated.models.EntitlementStatic or
     ~meterforge._generated.models.EntitlementBoolean]
    """
...
class EntitlementStatic(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.STATIC
...
class EntitlementV2PaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~meterforge._generated.models.EntitlementMeteredV2 or
     ~meterforge._generated.models.EntitlementStaticV2 or
     ~meterforge._generated.models.EntitlementBooleanV2]
    """
...
class EntitlementValue(_Model):
    """Entitlements are the core of MeterForge access management. They define access to features for
...
class ExpirationPeriod(_Model):
    ...
    :vartype duration: str or ~meterforge.models.ExpirationDuration
...
class Feature(_Model):
    ...
    :vartype advanced_meter_group_by_filters: dict[str, ~meterforge._generated.models.FilterString]
    :ivar unit_cost: Unit cost. Is either a FeatureManualUnitCost type or a FeatureLLMUnitCost
     type.
    :vartype unit_cost: ~meterforge._generated.models.FeatureManualUnitCost or
     ~meterforge._generated.models.FeatureLLMUnitCost
    :ivar id: Readonly unique ULID identifier. Required.
    :vartype id: str
    """
...
class FeatureLLMUnitCost(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.LLM
    ...
    :vartype pricing: ~meterforge._generated.models.FeatureLLMUnitCostPricing
    """
...
class FeatureManualUnitCost(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.MANUAL
...
class FeaturePaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~meterforge._generated.models.Feature]
    """
...
class FilterString(_Model):
    ...
    :vartype and_property: list[~meterforge._generated.models.FilterString]
    :ivar or_property: Provide a list of filters to be combined with a logical OR.
    :vartype or_property: list[~meterforge._generated.models.FilterString]
    """
...
class FilterTime(_Model):
    ...
    :ivar and_property: Provide a list of filters to be combined with a logical AND.
    :vartype and_property: list[~meterforge._generated.models.FilterTime]
    :ivar or_property: Provide a list of filters to be combined with a logical OR.
    :vartype or_property: list[~meterforge._generated.models.FilterTime]
    """
...
class FlatPrice(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.FLAT
...
class FlatPriceWithPaymentTerm(_Model):
    ...
    :vartype payment_term: str or ~meterforge.models.PricePaymentTerm
    """
...
class GrantBurnDownHistorySegment(_Model):
    ...
    :ivar grant_usages: Which grants were actually burnt down in the period and by what amount.
     Required.
    :vartype grant_usages: list[~meterforge._generated.models.GrantUsageRecord]
    """
...
class GrantPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~meterforge._generated.models.EntitlementGrant]
    """
...
class GrantV2PaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~meterforge._generated.models.EntitlementGrantV2]
    """
...
class IngestedEvent(_Model):
    ...
    :vartype event: ~meterforge._generated.models.Event
...
class Invoice(_Model):
     ...
     * credit_note: Reflects a refund either partial or complete of the preceding document. A
       ...
       and "credit_note".
    :vartype type: str or ~meterforge.models.InvoiceType
    ...
    :vartype customer: ~meterforge._generated.models.BillingInvoiceCustomerExtendedDetails
    ...
    :ivar preceding: Key information regarding previous invoices and potentially details as to why
     they were corrected.
    :vartype preceding: list[~meterforge._generated.models.CreditNoteOriginalInvoiceRef]
    :ivar totals: Summary of all the invoice totals, including taxes (calculated). Required.
    :vartype totals: ~meterforge._generated.models.InvoiceTotals
    ...
    :vartype status: str or ~meterforge.models.InvoiceStatus
    :ivar status_details: The details of the current invoice status. Required.
    :vartype status_details: ~meterforge._generated.models.InvoiceStatusDetails
    ...
    :vartype workflow: ~meterforge._generated.models.InvoiceWorkflowSettings
    :ivar lines: List of invoice lines representing each of the items sold to the customer.
    :vartype lines: list[~meterforge._generated.models.InvoiceLine]
    :ivar payment: Information on when, how, and to whom the invoice should be paid.
    :vartype payment: ~meterforge._generated.models.InvoicePaymentTerms
    :ivar validation_issues: Validation issues reported by the invoice workflow.
    :vartype validation_issues: list[~meterforge._generated.models.ValidationIssue]
    :ivar external_ids: External IDs of the invoice in other apps such as Stripe.
    :vartype external_ids: ~meterforge._generated.models.InvoiceAppExternalIds
    """
...
class InvoiceAvailableActions(_Model):
    ...
    :vartype advance: ~meterforge._generated.models.InvoiceAvailableActionDetails
    :ivar approve: Approve an invoice that requires manual approval.
    :vartype approve: ~meterforge._generated.models.InvoiceAvailableActionDetails
    :ivar delete: Delete the invoice (only non-issued invoices can be deleted).
    :vartype delete: ~meterforge._generated.models.InvoiceAvailableActionDetails
    :ivar retry: Retry an invoice issuing step that failed.
    :vartype retry: ~meterforge._generated.models.InvoiceAvailableActionDetails
    :ivar snapshot_quantities: Snapshot quantities for usage based line items.
    :vartype snapshot_quantities: ~meterforge._generated.models.InvoiceAvailableActionDetails
    :ivar void: Void an already issued invoice.
    :vartype void: ~meterforge._generated.models.InvoiceAvailableActionDetails
    :ivar invoice: Invoice a gathering invoice.
    :vartype invoice: ~meterforge._generated.models.InvoiceAvailableActionInvoiceDetails
    """
...
class InvoiceDetailedLine(_Model):
    ...
    :ivar managed_by: managedBy specifies if the line is manually added via the api or managed by
     MeterForge. Required. Known values are: "subscription", "system", and "manual".
    :vartype managed_by: str or ~meterforge.models.InvoiceLineManagedBy
    :ivar status: Status of the line.

     External calls always create valid lines, other line types are managed by the
     billing engine of MeterForge. Required. Known values are: "valid", "detailed", and "split".
    :vartype status: str or ~meterforge.models.InvoiceLineStatus
    ...
    :vartype discounts: ~meterforge._generated.models.InvoiceLineDiscounts
    ...
    :vartype credit_allocations: list[~meterforge._generated.models.InvoiceLineCreditAllocation]
    :ivar invoice: The invoice this item belongs to.
    :vartype invoice: ~meterforge._generated.models.InvoiceReference
    :ivar currency: The currency of this line. Required.
    :vartype currency: str
    :ivar taxes: Taxes applied to the invoice totals.
    :vartype taxes: list[~meterforge._generated.models.InvoiceLineTaxItem]
    :ivar tax_config: Tax config specify the tax configuration for this line.
    :vartype tax_config: ~meterforge._generated.models.TaxConfig
    ...
    :vartype period: ~meterforge._generated.models.Period
    :ivar external_ids: External IDs of the invoice in other apps such as Stripe.
    :vartype external_ids: ~meterforge._generated.models.InvoiceLineAppExternalIds
    :ivar subscription: Subscription are the references to the subscritpions that this line is
     related to.
    :vartype subscription: ~meterforge._generated.models.InvoiceLineSubscriptionReference
    ...
    :vartype type: str or ~meterforge._generated.models.FLAT_FEE
    ...
    :vartype rate_card: ~meterforge._generated.models.InvoiceDetailedLineRateCard
    :ivar category: Category of the flat fee. Known values are: "regular" and "commitment".
    :vartype category: str or ~meterforge.models.InvoiceDetailedLineCostCategory
    """
    ...
    """managedBy specifies if the line is manually added via the api or managed by MeterForge.
    ...
    """Status of the line.
     ...
     External calls always create valid lines, other line types are managed by the
     billing engine of MeterForge. Required. Known values are: \"valid\", \"detailed\", and
     \"split\"."""
...
class InvoiceDetailedLineRateCard(_Model):
    ...
    :vartype price: ~meterforge._generated.models.FlatPriceWithPaymentTerm
    :ivar quantity: Quantity of the item being sold.

     Default: 1.
    :vartype quantity: str
    :ivar discounts: The discounts that are applied to the line.
    :vartype discounts: ~meterforge._generated.models.BillingDiscounts
    """
...
class InvoiceLine(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.USAGE_BASED
    ...
    :vartype price: ~meterforge._generated.models.FlatPriceWithPaymentTerm or
     ~meterforge._generated.models.UnitPriceWithCommitments or
     ~meterforge._generated.models.TieredPriceWithCommitments or
     ~meterforge._generated.models.DynamicPriceWithCommitments or
     ~meterforge._generated.models.PackagePriceWithCommitments
    :ivar feature_key: The feature that the usage is based on.
    :vartype feature_key: str
    :ivar children: The lines detailing the item or service sold.
    :vartype children: list[~meterforge._generated.models.InvoiceDetailedLine]
    :ivar rate_card: The rate card that is used for this line.

     The rate card captures the intent of the price and discounts for the usage-based item.
    :vartype rate_card: ~meterforge._generated.models.InvoiceUsageBasedRateCard
...
class InvoiceLineAmountDiscount(_Model):
    ...
    :vartype reason: ~meterforge._generated.models.DiscountReasonMaximumSpend or
     ~meterforge._generated.models.DiscountReasonRatecardPercentage or
     ~meterforge._generated.models.DiscountReasonRatecardUsage
...
class InvoiceLineDiscounts(_Model):
    ...
    :vartype amount: list[~meterforge._generated.models.InvoiceLineAmountDiscount]
    :ivar usage: Usage based discounts applied to the line.
     ...
     applied.
    :vartype usage: list[~meterforge._generated.models.InvoiceLineUsageDiscount]
    """
...
class InvoiceLineSubscriptionReference(_Model):
    ...
    :vartype subscription: ~meterforge._generated.models.IDResource
    :ivar phase: The phase of the subscription. Required.
    :vartype phase: ~meterforge._generated.models.IDResource
    :ivar item: The item this line is related to. Required.
    :vartype item: ~meterforge._generated.models.IDResource
    ...
    :vartype billing_period: ~meterforge._generated.models.Period
    """
...
class InvoiceLineTaxItem(_Model):
    ...
    :vartype config: ~meterforge._generated.models.TaxConfig
    ...
    :vartype behavior: str or ~meterforge.models.InvoiceLineTaxBehavior
    """
...
class InvoicePaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~meterforge._generated.models.Invoice]
    """
...
class InvoicePaymentTerms(_Model):
    ...
    :vartype terms: ~meterforge._generated.models.PaymentTermInstant or
     ~meterforge._generated.models.PaymentTermDueDate
    """
...
class InvoicePendingLineCreateInput(_Model):
    ...
    :vartype lines: list[~meterforge._generated.models.InvoicePendingLineCreate]
    """
...
class InvoicePendingLineCreateResponse(_Model):
    ...
    :vartype invoice: ~meterforge._generated.models.Invoice
...
class InvoicePendingLinesActionInput(_Model):
    ...
    :vartype filters: ~meterforge._generated.models.InvoicePendingLinesActionFiltersInput
...
class InvoiceReplaceUpdate(_Model):
    ...
    :vartype supplier: ~meterforge._generated.models.BillingPartyReplaceUpdate
    :ivar customer: The customer the invoice is sent to. Required.
    :vartype customer: ~meterforge._generated.models.BillingPartyReplaceUpdate
    :ivar lines: The lines included in the invoice. Required.
    :vartype lines: list[~meterforge._generated.models.InvoiceLineReplaceUpdate]
    :ivar workflow: The workflow settings for the invoice. Required.
    :vartype workflow: ~meterforge._generated.models.InvoiceWorkflowReplaceUpdate
    """
...
class InvoiceSimulationInput(_Model):
    ...
    :vartype lines: list[~meterforge._generated.models.InvoiceSimulationLine]
    """
...
class InvoiceStatusDetails(_Model):
    ...
    :vartype available_actions: ~meterforge._generated.models.InvoiceAvailableActions
    """
...
class InvoiceWorkflowReplaceUpdate(_Model):
    ...
    :vartype workflow: ~meterforge._generated.models.InvoiceWorkflowSettingsReplaceUpdate
    """
...
class InvoiceWorkflowSettingsReplaceUpdate(_Model):
    ...
    :vartype invoicing: ~meterforge._generated.models.InvoiceWorkflowInvoicingSettingsReplaceUpdate
...
class ListRequestFilter(_Model):
    ...
    :ivar id:
    :vartype id: ~meterforge._generated.models.FilterString
    :ivar source:
    :vartype source: ~meterforge._generated.models.FilterString
    :ivar subject:
    :vartype subject: ~meterforge._generated.models.FilterString
    :ivar customer_id:
    :vartype customer_id: ~meterforge._generated.models.FilterIDExact
    :ivar type:
    :vartype type: ~meterforge._generated.models.FilterString
    :ivar time:
    :vartype time: ~meterforge._generated.models.FilterTime
    :ivar ingested_at:
    :vartype ingested_at: ~meterforge._generated.models.FilterTime
    """
...
class MarketplaceInstallResponse(_Model):
    ...
    :vartype app: ~meterforge._generated.models.StripeApp or
     ~meterforge._generated.models.SandboxApp or ~meterforge._generated.models.CustomInvoicingApp
    :ivar default_for_capability_types: Default for capabilities. Required.
    :vartype default_for_capability_types: list[str or ~meterforge.models.AppCapabilityType]
    """
...
class MarketplaceListing(_Model):
    ...
    :ivar type: The app's type. Required. Known values are: "stripe", "sandbox", and
     "custom_invoicing".
    :vartype type: str or ~meterforge.models.AppType
    ...
    :vartype capabilities: list[~meterforge._generated.models.AppCapability]
    :ivar install_methods: Install methods.

     List of methods to install the app. Required.
    :vartype install_methods: list[str or ~meterforge.models.InstallMethod]
    """
...
class MarketplaceListingPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~meterforge._generated.models.MarketplaceListing]
    """
...
class Meter(_Model):
    ...
    :vartype aggregation: str or ~meterforge.models.MeterAggregation
...
class MeterQueryRequest(_Model):
    ...
    :ivar window_size: If not specified, a single usage aggregate will be returned for the entirety
     ...
     and "MONTH".
    :vartype window_size: str or ~meterforge.models.WindowSize
...
class MeterQueryResult(_Model):
    ...
    :vartype data: list[~meterforge._generated.models.MeterQueryRow]
    """
...
class NotificationChannelMeta(_Model):
    ...
    :vartype type: str or ~meterforge.models.NotificationChannelType
    """
...
class NotificationChannelPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~meterforge._generated.models.NotificationChannelWebhook]
    """
...
class NotificationChannelWebhook(_Model):
    ...
    :vartype id: str
    :ivar type: Channel Type. Required. WEBHOOK.
    :vartype type: str or ~meterforge._generated.models.WEBHOOK
...
class NotificationEvent(_Model):
    ...
    :vartype type: str or ~meterforge.models.NotificationEventType
    :ivar created_at: Creation Time. Required.
    :vartype created_at: ~datetime.datetime
    ...
    :vartype rule: ~meterforge._generated.models.NotificationRuleBalanceThreshold or
     ~meterforge._generated.models.NotificationRuleEntitlementReset or
     ~meterforge._generated.models.NotificationRuleInvoiceCreated or
     ~meterforge._generated.models.NotificationRuleInvoiceUpdated
    :ivar delivery_status: Delivery Status. Required.
    :vartype delivery_status: list[~meterforge._generated.models.NotificationEventDeliveryStatus]
    ...
    :vartype payload: ~meterforge._generated.models.NotificationEventResetPayload or
     ~meterforge._generated.models.NotificationEventBalanceThresholdPayload or
     ~meterforge._generated.models.NotificationEventInvoiceCreatedPayload or
     ~meterforge._generated.models.NotificationEventInvoiceUpdatedPayload
    :ivar annotations: Annotations.
    :vartype annotations: ~meterforge._generated.models.Annotations
    """
...
class NotificationEventBalanceThresholdPayload(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.ENTITLEMENTS_BALANCE_THRESHOLD
    :ivar timestamp: Creation Time. Required.
    :vartype timestamp: ~datetime.datetime
    :ivar data: Payload Data. Required.
    :vartype data: ~meterforge._generated.models.NotificationEventBalanceThresholdPayloadData
    """
...
class NotificationEventBalanceThresholdPayloadData(_Model):  # pylint: disable=name-too-long
    ...
    :vartype entitlement: ~meterforge._generated.models.EntitlementMetered
    :ivar feature: Feature. Required.
    :vartype feature: ~meterforge._generated.models.Feature
    :ivar subject: Subject. Required.
    :vartype subject: ~meterforge._generated.models.Subject
    :ivar value: Entitlement Value. Required.
    :vartype value: ~meterforge._generated.models.EntitlementValue
    :ivar customer: Customer.
    :vartype customer: ~meterforge._generated.models.Customer
    :ivar threshold: Threshold. Required.
    :vartype threshold: ~meterforge._generated.models.NotificationRuleBalanceThresholdValue
    """
...
class NotificationEventDeliveryAttempt(_Model):
    ...
    :vartype state: str or ~meterforge.models.NotificationEventDeliveryStatusState
    :ivar response: Response returned by the notification event recipient. Required.
    :vartype response: ~meterforge._generated.models.EventDeliveryAttemptResponse
...
class NotificationEventDeliveryStatus(_Model):
    ...
    :vartype channel: ~meterforge._generated.models.NotificationChannelMeta
    :ivar annotations: Annotations.
    :vartype annotations: ~meterforge._generated.models.Annotations
    ...
    :vartype attempts: list[~meterforge._generated.models.NotificationEventDeliveryAttempt]
    """
...
class NotificationEventInvoiceCreatedPayload(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.INVOICE_CREATED
    :ivar timestamp: Creation Time. Required.
    :vartype timestamp: ~datetime.datetime
    :ivar data: Payload Data. Required.
    :vartype data: ~meterforge._generated.models.Invoice
    """
...
class NotificationEventInvoiceUpdatedPayload(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.INVOICE_UPDATED
    :ivar timestamp: Creation Time. Required.
    :vartype timestamp: ~datetime.datetime
    :ivar data: Payload Data. Required.
    :vartype data: ~meterforge._generated.models.Invoice
...
class NotificationEventPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~meterforge._generated.models.NotificationEvent]
    """
...
class NotificationEventResetPayload(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.ENTITLEMENTS_RESET
    :ivar timestamp: Creation Time. Required.
    :vartype timestamp: ~datetime.datetime
    :ivar data: Payload Data. Required.
    :vartype data: ~meterforge._generated.models.NotificationEventEntitlementValuePayloadBase
    """
...
class NotificationRuleBalanceThreshold(_Model):
    ...
    :vartype channels: list[~meterforge._generated.models.NotificationChannelMeta]
    :ivar annotations: Annotations.
    :vartype annotations: ~meterforge._generated.models.Annotations
    :ivar metadata: Metadata.
    :vartype metadata: ~meterforge._generated.models.Metadata
    :ivar thresholds: Entitlement Balance Thresholds. Required.
    :vartype thresholds: list[~meterforge._generated.models.NotificationRuleBalanceThresholdValue]
    :ivar features: Features.
    :vartype features: list[~meterforge._generated.models.FeatureMeta]
    """
...
class NotificationRuleBalanceThresholdValue(_Model):
    ...
    :vartype type: str or ~meterforge.models.NotificationRuleBalanceThresholdValueType
    """
...
class NotificationRulePaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~meterforge._generated.models.NotificationRuleBalanceThreshold or
     ~meterforge._generated.models.NotificationRuleEntitlementReset or
     ~meterforge._generated.models.NotificationRuleInvoiceCreated or
     ~meterforge._generated.models.NotificationRuleInvoiceUpdated]
    """
...
class PackagePriceWithCommitments(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.PACKAGE
...
class PaymentTermDueDate(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.DUE_DATE
    :ivar detail: Text detail of the chosen payment terms.
    :vartype detail: str
    :ivar notes: Description of the conditions for payment.
    :vartype notes: str
    :ivar due_at: When the payment is due. Required.
    :vartype due_at: list[~meterforge._generated.models.PaymentDueDate]
    """
...
class PaymentTermInstant(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.INSTANT
    :ivar detail: Text detail of the chosen payment terms.
    :vartype detail: str
    :ivar notes: Description of the conditions for payment.
    :vartype notes: str
...
class Plan(_Model):
    ...
    :ivar status: Status. Required. Known values are: "draft", "active", "archived", and
     "scheduled".
    :vartype status: str or ~meterforge.models.PlanStatus
    :ivar settlement_mode: Settlement mode. Known values are: "credit_then_invoice" and
     "credit_only".
    :vartype settlement_mode: str or ~meterforge.models.BillingSettlementMode
    :ivar phases: Plan phases. Required.
...
class PlanAddon(_Model):
    ...
    :vartype addon: ~meterforge._generated.models.Addon
...
class PlanAddonPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~meterforge._generated.models.PlanAddon]
    """
...
class PlanSubscriptionChange(_Model):
    ...
    :vartype plan: ~meterforge._generated.models.PlanReferenceInput
    :ivar starting_phase: The key of the phase to start the subscription in. If not provided, the
     subscription will start in the first phase of the plan.
    :vartype starting_phase: str
...
class PriceTier(_Model):
    ...
    :vartype flat_price: ~meterforge._generated.models.FlatPrice
    :ivar unit_price: Unit price component. Required.
    :vartype unit_price: ~meterforge._generated.models.UnitPrice
    """
...
class ProRatingConfig(_Model):
    ...
    :vartype mode: str or ~meterforge.models.ProRatingMode
    """
...
class RateCardFlatFee(_Model):
    ...
    :vartype entitlement_template: ~meterforge._generated.models.RateCardMeteredEntitlement or
     ~meterforge._generated.models.RateCardStaticEntitlement or
     ~meterforge._generated.models.RateCardBooleanEntitlement
    :ivar tax_config: Tax config.
    :vartype tax_config: ~meterforge._generated.models.TaxConfig
    :ivar billing_cadence: Billing cadence. Required.
    :vartype billing_cadence: ~datetime.timedelta
    ...
    :vartype discounts: ~meterforge._generated.models.Discounts
    """
...
class RecurringPeriod(_Model):
    ...
    :vartype interval: str or str or ~meterforge.models.RecurringPeriodIntervalEnum
...
class SandboxApp(_Model):
    """Sandbox app can be used for testing MeterForge features.
    ...
    :vartype type: str or ~meterforge._generated.models.SANDBOX
    """
...
class SandboxCustomerAppData(_Model):
    ...
    :vartype app: ~meterforge._generated.models.SandboxApp
    :ivar id: App ID.
    :vartype id: str
...
class StripeApp(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.STRIPE
...
class StripeCustomerAppData(_Model):
    ...
    :vartype app: ~meterforge._generated.models.StripeApp
    """
...
class StripeWebhookEvent(_Model):
    ...
    :vartype data: ~meterforge._generated.models.StripeWebhookEventData
    """
...
class Subscription(_Model):
    ...
    :vartype status: str or ~meterforge.models.SubscriptionStatus
    :ivar customer_id: The customer ID of the subscription. Required.
    :vartype customer_id: str
    :ivar plan: The plan of the subscription.
    :vartype plan: ~meterforge._generated.models.PlanReference
    :ivar currency: Currency. Required.
    :vartype currency: str
    :ivar billing_cadence: Billing cadence. Required.
    :vartype billing_cadence: ~datetime.timedelta
...
class SubscriptionAddon(_Model):
    ...
    :vartype active_to: ~datetime.datetime
    :ivar addon: Addon. Required.
    :vartype addon: ~meterforge._generated.models.SubscriptionAddonAddon
    ...
    :vartype timeline: list[~meterforge._generated.models.SubscriptionAddonTimelineSegment]
    :ivar subscription_id: SubscriptionID. Required.
    :vartype subscription_id: str
    :ivar rate_cards: Rate cards. Required.
    :vartype rate_cards: list[~meterforge._generated.models.SubscriptionAddonRateCard]
    """
...
class SubscriptionAddonCreate(_Model):
    ...
    :vartype timing: str or ~meterforge.models.SubscriptionTimingEnum or ~datetime.datetime
    :ivar addon: Addon. Required.
    :vartype addon: ~meterforge._generated.models.SubscriptionAddonCreateAddon
    """
...
class SubscriptionAlignment(_Model):
    ...
    :vartype current_aligned_billing_period: ~meterforge._generated.models.Period
    """
...
class SubscriptionBadRequestErrorResponse(_Model):
    ...
    :vartype extensions:
     ~meterforge._generated.models.SubscriptionBadRequestErrorResponseExtensions
    """
...
class SubscriptionBadRequestErrorResponseExtensions(_Model):  # pylint: disable=name-too-long
    ...
    :vartype validation_errors: list[~meterforge._generated.models.ErrorExtension]
    """
...
class SubscriptionChangeResponseBody(_Model):
    ...
    :vartype current: ~meterforge._generated.models.Subscription
    :ivar next: The subscription it will be changed to. Required.
    :vartype next: ~meterforge._generated.models.SubscriptionExpanded
    """
...
class SubscriptionEdit(_Model):
    ...
    :vartype customizations: list[~meterforge._generated.models.EditSubscriptionAddItem or
     ~meterforge._generated.models.EditSubscriptionRemoveItem or
     ~meterforge._generated.models.EditSubscriptionAddPhase or
     ~meterforge._generated.models.EditSubscriptionRemovePhase or
     ~meterforge._generated.models.EditSubscriptionStretchPhase or
     ~meterforge._generated.models.EditSubscriptionUnscheduleEdit]
...
class SubscriptionExpanded(_Model):
    ...
    :vartype alignment: ~meterforge._generated.models.SubscriptionAlignment
    :ivar phases: The phases of the subscription. Required.
    :vartype phases: list[~meterforge._generated.models.SubscriptionPhaseExpanded]
    """
...
class SubscriptionItem(_Model):
    ...
    :vartype included: ~meterforge._generated.models.SubscriptionItemIncluded
    :ivar tax_config: Tax config.
    :vartype tax_config: ~meterforge._generated.models.TaxConfig
    """
...
class SubscriptionItemIncluded(_Model):
    ...
    :vartype entitlement: ~meterforge._generated.models.EntitlementMetered or
     ~meterforge._generated.models.EntitlementStatic or
     ~meterforge._generated.models.EntitlementBoolean
    """
...
class SubscriptionPaginatedResponse(_Model):
    ...
    :vartype page_size: int
    :ivar items_property: The items in the current page. Required.
    :vartype items_property: list[~meterforge._generated.models.Subscription]
    """
...
class SubscriptionPhaseExpanded(_Model):
     ...
     * for future phases, the `items` contains only the first version of the item for each key.
       Required.
    :vartype items_property: list[~meterforge._generated.models.SubscriptionItem]
    :ivar item_timelines: Includes all versions of the items on each key, including all edits,
     scheduled changes, etc... Required.
    :vartype item_timelines: dict[str, list[~meterforge._generated.models.SubscriptionItem]]
    """
...
class TaxConfig(_Model):
    ...
    :vartype behavior: str or ~meterforge.models.TaxBehavior
    :ivar stripe: Stripe tax config.
    :vartype stripe: ~meterforge._generated.models.StripeTaxConfig
    :ivar custom_invoicing: Custom invoicing tax config.
    :vartype custom_invoicing: ~meterforge._generated.models.CustomInvoicingTaxConfig
...
class TieredPriceWithCommitments(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.TIERED
    :ivar mode: Mode. Required. Known values are: "volume" and "graduated".
    :vartype mode: str or ~meterforge.models.TieredPriceMode
    :ivar tiers: Tiers. Required.
    :vartype tiers: list[~meterforge._generated.models.PriceTier]
    :ivar minimum_amount: Minimum amount.
    :vartype minimum_amount: str
    :ivar maximum_amount: Maximum amount.
    :vartype maximum_amount: str
...
class UnitPrice(_Model):
    ...
    :vartype type: str or ~meterforge._generated.models.UNIT
...
class ValidationError(_Model):
    ...
    :vartype attributes: ~meterforge._generated.models.Annotations
    """
...
class ValidationIssue(_Model):
    ...
    :ivar severity: The severity of the issue. Required. Known values are: "critical" and
     "warning".
    :vartype severity: str or ~meterforge.models.ValidationIssueSeverity
...
class VoidInvoiceAction(_Model):
    ...
    :vartype action: ~meterforge._generated.models.VoidInvoiceLineDiscardAction or
     ~meterforge._generated.models.VoidInvoiceLinePendingAction
    """
...
class VoidInvoiceActionInput(_Model):
    ...
    :vartype action: ~meterforge._generated.models.VoidInvoiceAction
    ...
    :vartype overrides: list[~meterforge._generated.models.VoidInvoiceActionLineOverride]
    """
...
class VoidInvoiceLineDiscardAction(_Model):
    ...
    :ivar type: The action to take on the line item. Required. The line items will never be charged
     for again.
    :vartype type: str or ~meterforge._generated.models.DISCARD
    """
...
class VoidInvoiceLinePendingAction(_Model):
    ...
    :ivar type: The action to take on the line item. Required. Queue the line items into the
     ...
     now).
    :vartype type: str or ~meterforge._generated.models.PENDING
...
class WindowedBalanceHistory(_Model):
     ...
     * The last window may be smaller than the window size and is inclusive at both ends.
       Required.
    :vartype windowed_history: list[~meterforge._generated.models.BalanceHistoryWindow]
    :ivar burndown_history: Grant burndown history. Required.
    :vartype burndown_history: list[~meterforge._generated.models.GrantBurnDownHistorySegment]
    """
