...
class MeterForgeClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype portal: meterforge.operations.PortalOperations
    :ivar apps: AppsOperations operations
    :vartype apps: meterforge.operations.AppsOperations
    :ivar app_stripe: AppStripeOperations operations
    :vartype app_stripe: meterforge.operations.AppStripeOperations
    :ivar customer_apps: CustomerAppsOperations operations
    :vartype customer_apps: meterforge.operations.CustomerAppsOperations
    :ivar customers: CustomersOperations operations
    :vartype customers: meterforge.operations.CustomersOperations
    :ivar features: FeaturesOperations operations
    :vartype features: meterforge.operations.FeaturesOperations
    :ivar plans: PlansOperations operations
    :vartype plans: meterforge.operations.PlansOperations
    :ivar plan_addons: PlanAddonsOperations operations
    :vartype plan_addons: meterforge.operations.PlanAddonsOperations
    :ivar addons: AddonsOperations operations
    :vartype addons: meterforge.operations.AddonsOperations
    :ivar subscriptions: SubscriptionsOperations operations
    :vartype subscriptions: meterforge.operations.SubscriptionsOperations
    :ivar subscription_addons: SubscriptionAddonsOperations operations
    :vartype subscription_addons: meterforge.operations.SubscriptionAddonsOperations
    :ivar entitlements: EntitlementsOperations operations
    :vartype entitlements: meterforge.operations.EntitlementsOperations
    :ivar grants: GrantsOperations operations
    :vartype grants: meterforge.operations.GrantsOperations
    :ivar subjects: SubjectsOperations operations
    :vartype subjects: meterforge.operations.SubjectsOperations
    :ivar customer: CustomerOperations operations
    :vartype customer: meterforge.operations.CustomerOperations
    :ivar customer_entitlement: CustomerEntitlementOperations operations
    :vartype customer_entitlement: meterforge.operations.CustomerEntitlementOperations
    :ivar customer_stripe: CustomerStripeOperations operations
    :vartype customer_stripe: meterforge.operations.CustomerStripeOperations
    :ivar marketplace: MarketplaceOperations operations
    :vartype marketplace: meterforge.operations.MarketplaceOperations
    :ivar app_custom_invoicing: AppCustomInvoicingOperations operations
    :vartype app_custom_invoicing: meterforge.operations.AppCustomInvoicingOperations
    :ivar events: EventsOperations operations
    :vartype events: meterforge.operations.EventsOperations
    :ivar events_v2: EventsV2Operations operations
    :vartype events_v2: meterforge.operations.EventsV2Operations
    :ivar meters: MetersOperations operations
    :vartype meters: meterforge.operations.MetersOperations
    :ivar subjects: SubjectsOperations operations
    :vartype subjects: meterforge.operations.SubjectsOperations
    :ivar debug: DebugOperations operations
    :vartype debug: meterforge.operations.DebugOperations
    :ivar notification_channels: NotificationChannelsOperations operations
    :vartype notification_channels: meterforge.operations.NotificationChannelsOperations
    :ivar notification_rules: NotificationRulesOperations operations
    :vartype notification_rules: meterforge.operations.NotificationRulesOperations
    :ivar notification_events: NotificationEventsOperations operations
    :vartype notification_events: meterforge.operations.NotificationEventsOperations
    :ivar entitlements_v2: EntitlementsV2Operations operations
    :vartype entitlements_v2: meterforge.operations.EntitlementsV2Operations
    :ivar customer_entitlements_v2: CustomerEntitlementsV2Operations operations
    :vartype customer_entitlements_v2: meterforge.operations.CustomerEntitlementsV2Operations
    :ivar customer_entitlement_v2: CustomerEntitlementV2Operations operations
    :vartype customer_entitlement_v2: meterforge.operations.CustomerEntitlementV2Operations
    :ivar grants_v2: GrantsV2Operations operations
    :vartype grants_v2: meterforge.operations.GrantsV2Operations
    :ivar billing_profiles: BillingProfilesOperations operations
    :vartype billing_profiles: meterforge.operations.BillingProfilesOperations
    :ivar customer_overrides: CustomerOverridesOperations operations
    :vartype customer_overrides: meterforge.operations.CustomerOverridesOperations
    :ivar invoices: InvoicesOperations operations
    :vartype invoices: meterforge.operations.InvoicesOperations
    :ivar invoice: InvoiceOperations operations
    :vartype invoice: meterforge.operations.InvoiceOperations
    :ivar customer_invoice: CustomerInvoiceOperations operations
    :vartype customer_invoice: meterforge.operations.CustomerInvoiceOperations
    :ivar progress: ProgressOperations operations
    :vartype progress: meterforge.operations.ProgressOperations
    :ivar currencies: CurrenciesOperations operations
    :vartype currencies: meterforge.operations.CurrenciesOperations
