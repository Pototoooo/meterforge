...
func (s *InvoicesService) List(ctx context.Context, params InvoiceListParams) (*InvoicePagePaginatedResponse, error) {
	path := "/meterforge/billing/invoices"
...
func (s *InvoicesService) Get(ctx context.Context, invoiceID string) (*Invoice, error) {
	if invoiceID == "" {
		return nil, fmt.Errorf("meterforge: %s must not be empty: %w", "invoiceID", ErrEmptyID)
	}

	path := "/meterforge/billing/invoices/{invoiceId}"
...
func (s *InvoicesService) Delete(ctx context.Context, invoiceID string) error {
	if invoiceID == "" {
		return fmt.Errorf("meterforge: %s must not be empty: %w", "invoiceID", ErrEmptyID)
	}
...
func (s *InvoicesService) Advance(ctx context.Context, invoiceID string) (*Invoice, error) {
	...
	path := "/meterforge/billing/invoices/{invoiceId}/advance"
...
func (s *InvoicesService) Approve(ctx context.Context, invoiceID string) (*Invoice, error) {
	...
	path := "/meterforge/billing/invoices/{invoiceId}/approve"
...
func (s *InvoicesService) Retry(ctx context.Context, invoiceID string) (*Invoice, error) {
	...
	path := "/meterforge/billing/invoices/{invoiceId}/retry"
...
func (s *InvoicesService) SnapshotQuantities(ctx context.Context, invoiceID string) (*Invoice, error) {
	...
	path := "/meterforge/billing/invoices/{invoiceId}/snapshot-quantities"
