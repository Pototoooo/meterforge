...
func (s *CustomersCreditsGrantsService) Create(ctx context.Context, customerID string, request CreateCreditGrantRequest) (*CreditGrant, error) {
	...
	path := "/meterforge/customers/{customerId}/credits/grants"
...
func (s *CustomersCreditsGrantsService) Get(ctx context.Context, customerID string, creditGrantID string) (*CreditGrant, error) {
	...
	if creditGrantID == "" {
		return nil, fmt.Errorf("meterforge: %s must not be empty: %w", "creditGrantID", ErrEmptyID)
	}

	path := "/meterforge/customers/{customerId}/credits/grants/{creditGrantId}"
...
func (s *CustomersCreditsGrantsService) Void(ctx context.Context, customerID string, creditGrantID string, request *VoidCreditGrantRequest) (*CreditGrant, error) {
	...
	path := "/meterforge/customers/{customerId}/credits/grants/{creditGrantId}/void"
...
func (s *CustomersCreditsGrantsService) UpdateExternalSettlement(ctx context.Context, customerID string, creditGrantID string, request UpdateCreditGrantExternalSettlementRequest) (*CreditGrant, error) {
	...
	path := "/meterforge/customers/{customerId}/credits/grants/{creditGrantId}/settlement/external"
