...
export const lifecycleController = z
  ...
  .describe(
    'Identifies whether a resource lifecycle is controlled by MeterForge or manually overridden by the API user. Values: - `system`: The resource lifecycle is controlled by MeterForge. - `manual`: The resource lifecycle was manually overridden by the API user.',
  )
