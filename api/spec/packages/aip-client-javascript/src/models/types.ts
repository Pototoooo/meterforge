...
export interface ChargeFlatFee {
  ...
  /**
   * Indicates whether the charge lifecycle is controlled by MeterForge or manually
...
export interface InvoiceStandardLine {
  ...
  type: 'standard_line'
  /**
   * Indicates whether this line item's lifecycle is controlled by MeterForge or
