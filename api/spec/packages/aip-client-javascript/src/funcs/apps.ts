...
export function listApps(
  ...
  return request(() => {
    ...
    return http(client)
      .get('meterforge/apps', { ...options, searchParams })
      .json()
      .then((data) => {
        if (client._options.validate) {
...
export function listAppCatalog(
  ...
  return request(() => {
    ...
    const searchParams = toURLSearchParams(query)
    return http(client)
      .get('meterforge/app-catalog', { ...options, searchParams })
      .json()
      .then((data) => {
        if (client._options.validate) {
...
export function getAppCatalogItem(
  ...
  return request(() => {
    ...
    const path = `meterforge/app-catalog/${(() => {
...
export function installApp(
  ...
  return request(() => {
    ...
    return http(client)
      .post('meterforge/app-catalog/install', { ...options, json: body })
      .json()
      .then((data) => {
        if (client._options.validate) {
