...
export function listLlmCostPrices(
  ...
  return request(() => {
    ...
    return http(client)
      .get('meterforge/llm-cost/prices', { ...options, searchParams })
      .json()
      .then((data) => {
        if (client._options.validate) {
...
export function getLlmCostPrice(
  ...
  return request(() => {
    ...
    const path = `meterforge/llm-cost/prices/${(() => {
...
export function listLlmCostOverrides(
  ...
  return request(() => {
    ...
    const searchParams = toURLSearchParams(query)
    return http(client)
      .get('meterforge/llm-cost/overrides', { ...options, searchParams })
      .json()
      .then((data) => {
        if (client._options.validate) {
...
export function createLlmCostOverride(
  ...
  return request(() => {
    ...
    return http(client)
      .post('meterforge/llm-cost/overrides', { ...options, json: body })
      .json()
      .then((data) => {
        if (client._options.validate) {
...
export function deleteLlmCostOverride(
  ...
  return request(async () => {
    ...
    const path = `meterforge/llm-cost/overrides/${(() => {
      if (pathParams.priceId === undefined) {
        throw new Error('missing path parameter: priceId')
      }
      return encodeURIComponent(String(pathParams.priceId))
