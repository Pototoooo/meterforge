...
- Keep third-party website snapshots outside the project documentation tree. Preserve their original source and attribution in a separate reference archive; do not relabel external product documentation as MeterForge documentation. Distinguish real dependency module paths and historical migration identifiers from project branding when auditing names.
